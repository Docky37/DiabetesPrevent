...
import com.mediscreen.patient.adm.enums.Gender;
...
public class Patient {
    ...
    @Column(nullable = false, length = PatientsAdmConstants.FIRSTNAME_MAX_LENGTH)
    ...
    @Column(nullable = false, length = PatientsAdmConstants.LASTNAME_MAX_LENGTH)
